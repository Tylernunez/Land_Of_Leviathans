...
public class PlayerNetwork : MonoBehaviour {
    ...
    private PlayerInputController CurrentPlayer;
    ...
    private void RPC_CreatePlayer()
    {
        ...
        GameObject obj = PhotonNetwork.Instantiate(Path.Combine("Prefabs", "NewPlayer"), spawnPoint * randomValue, Quaternion.identity,0);
        CurrentPlayer = obj.GetComponent<PlayerInputController>();
    }
}
